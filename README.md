...
- `meirenzhi`（凡人修仙传 · 美人志）是**非官方粉丝作品**，与《凡人修仙传》版权方无关联、未获授权；内置 12 张壁纸（4 张合照 + 8 张单人）均为 AI 生成粉丝画作（由插件作者提供），掌天瓶站点图标为原创代码绘制 SVG，美人志徽章由 HTML/CSS 绘制、萤火粒子由 CSS 伪元素与径向渐变绘制，均不包含官方素材。绯红鎏金亮暗双态，出厂标语「风起凡尘 · 红颜问道」。
